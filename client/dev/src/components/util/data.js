...
const backgrounds = [
    ...
    {bg: 'Guild Artisan', dsc: 'Your skill in a particular craft has earned you membership in a mercantile guild, offering privileges and protection while engaging in your art. Repairing and discovering rare crafts will bring new inspiration.'},
...
const spells = [
    {bg: 'Eldritch Blast', dsc: 'The cantrip allows the spellcaster to shoot out an energy beam that deals Force damage, and that can be upgraded with Warlock abilities.'},
    {bg: 'Fireball', dsc: 'This spell allows spellcasters to unleash a streak of fire from their hands that ignites into a large explosion at a chosen point within range.'},
    {bg: 'Song of Rest', dsc: 'This ability allows the Bard to restore their allies strength by granting an additional Short Rest once per day.'},
    {bg:'Healing Word', dsc: 'This spell allows spellcasters to heal allies that they can see within range.'},
    {bg: 'Wild Shape', dsc: 'An Action gained by Druids that allows them to magically transform into various creatures in order to fight in combat or explore the environment.'},
    {bg: 'Mage Hand', dsc: 'It conjures a spectral hand that can interact with objects.'},
    {bg: 'Counterspell', dsc: 'This spell allows spellcasters to interrupt another casters spellcasting, causing it to fail and have no effect.'},
    {bg: 'Lay on Hands', dsc: 'This ability allows the Paladin to heal a creature or cure it of diseases and poisons.'},
    {bg: 'Hunters Mark', dsc: 'This spell allows spellcasters to mark a creature as their prey and deal additional Weapon damage to the targeted creature.'}
];
